...
const Requests = () => {
  ...
  const fetchRequests = async () => {
    try {
      const response = await axios.get(
        `http://localhost:3001/requests/${currentUser._id}`,
      );
  ...
  const fetchSentRequests = async () => {
    try {
      const response = await axios.get(
        `http://localhost:3001/sentRequests/${currentUser._id}`,
      );
  ...
  const acceptRequest = async (id) => {
    try {
      await axios.put(`http://localhost:3001/request/accept/${id}`);
  ...
  const rejectRequest = async (id) => {
    try {
      await axios.put(`http://localhost:3001/request/reject/${id}`);
  ...
  const deleteRequest = async (id) => {
    try {
      await axios.delete(`http://localhost:3001/request/${id}`);
